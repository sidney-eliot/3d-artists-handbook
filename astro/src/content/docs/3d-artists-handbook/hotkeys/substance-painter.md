...
![banner\_substance\_painter.jpg](../../../../assets/3d-artists-handbook/images/banner_substance_painter.jpg)
...
*(Edit>Settings>Shortcuts)*
Camera rotate ➡️ `MMB`
Camera snap rotate ➡️ `Alt` + `MMB`
Camera translate ➡️ `Shift` + `MMB`
Camera zoom ➡️ `Ctrl` + `MMB`
Auto focus ➡️ `Ctrl` + `Alt` + `Shift` + `MMB` *(this one as well, as it would be in the way of another hotkey)*
