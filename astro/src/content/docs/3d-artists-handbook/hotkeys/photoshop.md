...
![banner\_photoshop.jpg](../../../../assets/3d-artists-handbook/images/banner_photoshop.jpg)

## General

|            Function            |            Key            |                                   Notes                                  |
| :----------------------------: | :-----------------------: | :----------------------------------------------------------------------: |
|     Brush Settings *(menu)*    | `Window > Brush Settings` |                                                                          |
|      Tool Preset *(menu)*      |          `Window`         |                                                                          |
...
[https://helpx.adobe.com/photoshop/using/default-keyboard-shortcuts.html](https://helpx.adobe.com/photoshop/using/default-keyboard-shortcuts.html)
