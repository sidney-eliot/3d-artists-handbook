...
![banner\_zbrush.jpg](../../../../assets/3d-artists-handbook/images/banner_zbrush.jpg)

## General Things to Be Aware Of

* Having an efficient workflow between ZBrush and other software is key. More on that [here](/3d-artists-handbook/model-creation/workflow-between-zbrush-and-blender)
...
3. A .psd file extension *(this is quite stupid and hopefully fixed in the future)*
...
![image-2023-10-15-02-12-45.png](../../../../assets/3d-artists-handbook/images/image-2023-10-15-02-12-45.png)

:::note[Batch method (recommended)]
Open action window.<br />
![image-2023-10-15-02-53-06.png](../../../../assets/3d-artists-handbook/images/image-2023-10-15-02-53-06.png)<br />
Create and start recording of action.<br />
![image-2023-10-15-02-54-46.png](../../../../assets/3d-artists-handbook/images/image-2023-10-15-02-54-46.png)<br />
![image-2023-10-15-02-59-46.png](../../../../assets/3d-artists-handbook/images/image-2023-10-15-02-59-46.png)<br />
Convert to grayscale.<br />
![image-2023-10-15-03-05-17.png](../../../../assets/3d-artists-handbook/images/image-2023-10-15-03-05-17.png)<br />
Convert to 8bit or 16bit channel.<br />
![image-2023-10-15-04-40-54.png](../../../../assets/3d-artists-handbook/images/image-2023-10-15-04-40-54.png)<br />
Stop action recording.<br />
![image-2023-10-15-03-18-25.png](../../../../assets/3d-artists-handbook/images/image-2023-10-15-03-18-25.png)<br />
Open Image Processor Script (come with Photoshop)<br />
![image-2023-10-15-04-06-46.png](../../../../assets/3d-artists-handbook/images/image-2023-10-15-04-06-46.png)<br />
...
![image-2023-10-15-04-36-28.png](../../../../assets/3d-artists-handbook/images/image-2023-10-15-04-36-28.png)
...
[Alphas](#alpha-brush) can pull out shapes onto the mesh. [VMD brushes](#vdm-brush) work similarly, just that they allow for overhangs, so much more complex shapes are possible. [Insert mesh brushes](#insert-mesh-brush) place objects on other surfaces, but with some tweaking, they can also become [Curve insert mesh brushes](#curve-insert-mesh-brush) for creating objects like chains and ropes. [Nano meshes](#nano-mesh) are similar to **Insert Mesh Brushes**, just that they place the object on every face. This can be very useful for creating patterns or clothing pieces like fishnet stockings. Finally, there are the [Normal sculpting brushes](#sculpting-brush), for example Clay Strips or Dam Standard. They store alphas, drag mode as well as other brush related settings and can even have custom preview icons.
...
:::caution[Where are these save methods located?]
...
:::tip[Polypaint resources (videos)]
...
* To **delete** colors from the palette, right click delete colors *(will only work when Direct mode is off)*
...
* `Fill Object mode` (paint bucket button) fills the selected SubTool with the selected ZColor color *(Fill Object mode synergizes with Direct mode)*
...
:::tip[Rendering in ZBrush resources (videos)]
...
:::caution[How to get rid of the empty document border?]
...
:::danger[ZBrush file extension is .ZZZ instead of .ZTL]
