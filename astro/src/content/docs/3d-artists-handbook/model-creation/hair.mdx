...
import bitted from '../../../../assets/3d-artists-handbook/images/pasted-image-20230604170808.png'

import czilss from '../../../../assets/3d-artists-handbook/images/pasted-image-20230604170824.png'

import rpizna from '../../../../assets/3d-artists-handbook/images/pasted-image-20230604170858.png'

import vzuoyb from '../../../../assets/3d-artists-handbook/images/pasted-image-20230604170907.png'

import ohemsl from '../../../../assets/3d-artists-handbook/images/pasted-image-20230604170758.png'

import ycytrc from '../../../../assets/3d-artists-handbook/images/pasted-image-20230604170921.png'

import lkkvkj from '../../../../assets/3d-artists-handbook/images/pasted-image-20230604174906.png'

import eqhzer from '../../../../assets/3d-artists-handbook/images/pasted-image-20230604174914.png'

import xwagar from '../../../../assets/3d-artists-handbook/images/pasted-image-20230604174921.png'
...
<Image src={bitted} alt="" width="350" height="auto" /><Image src={czilss} alt="" width="350" height="auto" /><Image src={rpizna} alt="" width="300" height="auto" /><Image src={vzuoyb} alt="" width="300" height="auto" /><Image src={ohemsl} alt="" width="250" height="auto" /><Image src={ycytrc} alt="" width="600" height="auto" />
...
<Image src={lkkvkj} alt="" width="400" height="auto" /> <Image src={eqhzer} alt="" width="400" height="auto" /> <Image src={xwagar} alt="" width="400" height="auto" />
