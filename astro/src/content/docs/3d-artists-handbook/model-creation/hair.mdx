...
import ponvke from '../../../../assets/3d-artists-handbook/images/pasted-image-20230604170808.png'

import hkbdlx from '../../../../assets/3d-artists-handbook/images/pasted-image-20230604170824.png'

import pchbjy from '../../../../assets/3d-artists-handbook/images/pasted-image-20230604170858.png'

import gzqylc from '../../../../assets/3d-artists-handbook/images/pasted-image-20230604170907.png'

import ymowez from '../../../../assets/3d-artists-handbook/images/pasted-image-20230604170758.png'

import ivdctl from '../../../../assets/3d-artists-handbook/images/pasted-image-20230604170921.png'

import gytkeo from '../../../../assets/3d-artists-handbook/images/pasted-image-20230604174906.png'

import mjuzae from '../../../../assets/3d-artists-handbook/images/pasted-image-20230604174914.png'

import glmfdn from '../../../../assets/3d-artists-handbook/images/pasted-image-20230604174921.png'
...
* [https://80.lv/articles/creating-hair-for-real-time-game-characters/](https://80.lv/articles/creating-hair-for-real-time-game-characters/)
* [https://80.lv/articles/creating-hair-for-real-time-projects/](https://80.lv/articles/creating-hair-for-real-time-projects/)
...
<Image src={ponvke} alt="" width="350" height="auto" /><Image src={hkbdlx} alt="" width="350" height="auto" /><Image src={pchbjy} alt="" width="300" height="auto" /><Image src={gzqylc} alt="" width="300" height="auto" /><Image src={ymowez} alt="" width="250" height="auto" /><Image src={ivdctl} alt="" width="600" height="auto" />
...
<Image src={gytkeo} alt="" width="400" height="auto" /> <Image src={mjuzae} alt="" width="400" height="auto" /> <Image src={glmfdn} alt="" width="400" height="auto" />
...
:::tip[Creating hair card texture maps (videos)]
...
![Pasted image 20230604224005.png](../../../../assets/3d-artists-handbook/images/pasted-image-20230604224005.png)
...
* Render with the correct image extension (more about that [here](/3d-artists-handbook/theory/texture-maps))
...
* Place a flat colored neutral gray (#7F7F7F) background behind the hair (this is done to help the [anti aliasing](/3d-artists-handbook/theory/glossary#anti-aliasing) by bouncing softer light and thus producing crisper edges)

:::

:::tip[Rendering hair cards (videos)]
...
:::note[Software with particle hair support]
...
Particle Hair in Blender *(pre 3.3)*:
...
:::note[Finished hair card textures & hairstyles]
