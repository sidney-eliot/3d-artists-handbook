...
import tgyzvn from '../../../../assets/3d-artists-handbook/images/20230603110116.png'

import bbjzms from '../../../../assets/3d-artists-handbook/images/20230603123401.png'

import yqjagk from '../../../../assets/3d-artists-handbook/images/20230603111140.png'

import ynnvtx from '../../../../assets/3d-artists-handbook/images/20230603111548.png'

import pbunrn from '../../../../assets/3d-artists-handbook/images/20230603111310.png'

import rnzszg from '../../../../assets/3d-artists-handbook/images/20230603111506.png'

import mxxomm from '../../../../assets/3d-artists-handbook/images/pasted-image-20230603124930.png'

import gwzjpa from '../../../../assets/3d-artists-handbook/images/pasted-image-20230603125616.png'

import bbaqmn from '../../../../assets/3d-artists-handbook/images/pasted-image-20230603125653.png'

import lfjeoy from '../../../../assets/3d-artists-handbook/images/pasted-image-20230603130631.png'

import jjfjal from '../../../../assets/3d-artists-handbook/images/pasted-image-20230603130821.png'

import utiocd from '../../../../assets/3d-artists-handbook/images/pasted-image-20230603131037.png'
...
*\[[Wikipedia](https://en.wikipedia.org/wiki/Ambient_occlusion)] - \[[Polycount](http://wiki.polycount.com/wiki/Ambient_occlusion_map)] - \[[Unreal Engine Doc](https://docs.unrealengine.com/4.27/en-US/RenderingAndGraphics/PostProcessEffects/AmbientOcclusion/)] - \[[Unity Doc](https://docs.unity3d.com/2021.3/Documentation/Manual/LightingBakedAmbientOcclusion.html)]*
...
:::note[Ambient Occlusion Info]


* Softens the overall lighting in your scene
* Adds depth
* Can be used as a budget [ray traced](/3d-artists-handbook/theory/glossary#ray-tracing) occlusion
...
| :--------------------------------------------------------------------------------: | :------------------------------------------------------------------------------: |
|    ![AO\_off\_1.png](../../../../assets/3d-artists-handbook/images/ao_off_1.png)   |    ![AO\_on\_1.png](../../../../assets/3d-artists-handbook/images/ao_on_1.png)   |
|    ![AO\_off\_2.png](../../../../assets/3d-artists-handbook/images/ao_off_2.png)   |    ![AO\_on\_2.png](../../../../assets/3d-artists-handbook/images/ao_on_2.png)   |
| ![tdmMtT4\_off.png](../../../../assets/3d-artists-handbook/images/tdmmtt4_off.png) | ![tdmMtT4\_on.png](../../../../assets/3d-artists-handbook/images/tdmmtt4_on.png) |

***

### Ray Tracing

*\[[Wikipedia](https://en.wikipedia.org/wiki/Ray_tracing_\(graphics\))] - \[[Unreal Engine Showcase](https://www.unrealengine.com/en-US/explainers/ray-tracing/what-is-real-time-ray-tracing)] - \[[Unreal Engine Doc (real-time)](https://docs.unrealengine.com/4.26/en-US/RenderingAndGraphics/RayTracing/)] - \[[Unreal Engine Doc (hardware)](https://docs.unrealengine.com/5.0/en-US/hardware-ray-tracing-in-unreal-engine/)] - \[[Unity Doc](https://docs.unity3d.com/Packages/com.unity.render-pipelines.high-definition@14.0/manual/Ray-Tracing-Getting-Started.html)] - \[[Ray Tracing in One Weekend](https://raytracing.github.io/books/RayTracingInOneWeekend.html)] - \[[Ray Tracing Gems Series](https://www.realtimerendering.com/raytracinggems/)]*
...
* Ray Traced Lighting
* Ray Traced [Ambient Occlusion](/3d-artists-handbook/theory/glossary#ambient-occlusion)
...
:::note[Graphics Card Specifications]
...
<Image src={tgyzvn} alt="" width="600" height="auto" /> <Image src={bbjzms} alt="" width="600" height="auto" />

On the flipped side, here's an example of ray tracing making the lighting and shadows look way worse:

<Image src={yqjagk} alt="" width="600" height="auto" />
...
*\[[Real-time Rendering Book (4th Edition)](https://www.amazon.de/-/en/Tomas-Akenine-M%C3%B6ller/dp/1138627003)] - \[[Real-time Rendering Book Digital Summary (4th Edition)](https://www.realtimerendering.com/)]*

***

### Subsurface Scattering

*\[[Wikipedia](https://en.wikipedia.org/wiki/Subsurface_scattering)]*
...
:::note[Theory behind real life subsurface scattering (Transparency & Translucency)]
...
:::tip[Objects that don't scatter light with low absorption]
...
<Image src={ynnvtx} alt="" width="50" height="auto" />

:::tip[Objects where SSS is vital]
...
<Image src={pbunrn} alt="" width="600" height="auto" />
...
[https://youtu.be/7l6QOcgWXfI](https://youtu.be/7l6QOcgWXfI)
...
<Image src={rnzszg} alt="" width="400" height="auto" />

***

### Volumetric Effects

*ToDo: add in term Volumetric Sampling*

#### Volumetric Lighting

Volumetric lighting or God Rays lets beams of light shine across the environment.

<Image src={mxxomm} alt="" width="500" height="auto" />

#### Volumetric Fog

:::tip[Volumetric Fog is used for]
...
<Image src={gwzjpa} alt="" width="700" height="auto" />
...
<Image src={bbaqmn} alt="" width="700" height="auto" />
...
:::tip[Masked Blend & Alpha Clip Examples]
...
:::tip[Translucent Blend & Alpha Hashed Examples]
...
:::tip[Objects that reflect light]
...
<Image src={lfjeoy} alt="" width="400" height="auto" />
...
<Image src={jjfjal} alt="" width="500" height="auto" />
...
:::tip[Objects with high scattering and high absorption] 
:::

:::tip[Objects with high scattering and low absorption]
...
<Image src={utiocd} alt="" width="400" height="auto" />

***

### Physically based rendering

*\[[Allegorithmic's PBR Guide Part 1](https://creativecloud.adobe.com/cc/learn/substance-3d-designer/web/the-pbr-guide-part-1)] - \[[Allegorithmic's PBR Guide Part 2](https://creativecloud.adobe.com/learn/substance-3d-designer/web/the-pbr-guide-part-2)] - \[[Physically Based Rendering: From Theory To Implementation (4th edition)](https://www.pbr-book.org/)]*
...
ToDo: And other types of rendering techniques: [https://3d-ace.com/blog/different-rendering-techniques/](https://3d-ace.com/blog/different-rendering-techniques/)
...
Almost all render and game engines will convert **quads** and **n-gons** into **triangles** at render time. This is why it's important for **quads** and **n-gons** to be as planar as possible, as [triangulating](/3d-artists-handbook/theory/glossary#triangulation) them can change the silhouette and shading when they aren't flat. More on that in the [triangulation](/3d-artists-handbook/theory/glossary#triangulation) section.
...
**Triangulation**, also referred to as **tessellation**, is the process of the converting [quads and n-gons](/3d-artists-handbook/theory/glossary#polygon-vertex-edge-triangle-quad-n-gon) to triangles. In the case of a quad, for example, there are two ways of **triangulating** it. The way in which quads and n-gons are triangulated depends on the algorithm that is used, and thus can differ between software and even versions of the same software.

As an artist, working on a character's final retopology, one wants to make sure that what one is seeing, will look exactly like that in the game engine. Thus, it's important *ToDo*
...
[https://ianthehenry.com/posts/delaunay/](https://ianthehenry.com/posts/delaunay/)
[https://paulbourke.net/papers/triangulate/](https://paulbourke.net/papers/triangulate/)
[https://www.cs.cmu.edu/\~quake/triangle.html](https://www.cs.cmu.edu/~quake/triangle.html)
[https://docs.blender.org/manual/en/latest/modeling/modifiers/generate/triangulate.html](https://docs.blender.org/manual/en/latest/modeling/modifiers/generate/triangulate.html)
[https://polycount.com/discussion/105479/question-about-baking-with-triangulation](https://polycount.com/discussion/105479/question-about-baking-with-triangulation)
[https://discourse.techart.online/t/when-to-triangulate-in-a-pipeline/4654](https://discourse.techart.online/t/when-to-triangulate-in-a-pipeline/4654)
...
A **Smoothing split**, also sometimes referred to as a **shading split**, is when *ToDo (include terms "soft edge", "sharp edge" and "hard edge")*.
...
:::tip[Some related articles]


* [https://polycount.com/discussion/107196/making-sense-of-hard-edges-uvs-normal-maps-and-vertex-counts/p1](https://polycount.com/discussion/107196/making-sense-of-hard-edges-uvs-normal-maps-and-vertex-counts/p1)
...
*\[[Wikipedia](https://en.wikipedia.org/wiki/Color_depth)] - \[[Polycount](http://wiki.polycount.com/wiki/BitDepth)] - \[[Photoshop Doc](https://helpx.adobe.com/photoshop/using/bit-depth.html)]*

:::tip[Bit depth explanation (videos)]
...
:::note[16bit image (Integer / Float)]
...
:::note[32bit image (Integer / Float)]
...
To-Do
[https://marmoset.co/posts/toolbag-baking-tutorial/](https://marmoset.co/posts/toolbag-baking-tutorial/)
