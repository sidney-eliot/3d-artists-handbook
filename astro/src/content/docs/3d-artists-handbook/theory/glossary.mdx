...
import aoxpqw from '../../../../assets/3d-artists-handbook/images/20230603110116.png'

import gfhmst from '../../../../assets/3d-artists-handbook/images/20230603123401.png'

import driuzv from '../../../../assets/3d-artists-handbook/images/20230603111140.png'

import hqlitc from '../../../../assets/3d-artists-handbook/images/20230603111548.png'

import tbffpe from '../../../../assets/3d-artists-handbook/images/20230603111310.png'

import cmjcof from '../../../../assets/3d-artists-handbook/images/20230603111506.png'

import iottne from '../../../../assets/3d-artists-handbook/images/pasted-image-20230603124930.png'

import sslwen from '../../../../assets/3d-artists-handbook/images/pasted-image-20230603125616.png'

import nnkyev from '../../../../assets/3d-artists-handbook/images/pasted-image-20230603125653.png'

import rbnvuf from '../../../../assets/3d-artists-handbook/images/pasted-image-20230603130631.png'

import dmlame from '../../../../assets/3d-artists-handbook/images/pasted-image-20230603130821.png'

import oieexl from '../../../../assets/3d-artists-handbook/images/pasted-image-20230603131037.png'
...
<Image src={aoxpqw} alt="" width="600" height="auto" /> <Image src={gfhmst} alt="" width="600" height="auto" />

On the flipped side, here's an example of ray tracing making the lighting and shadows look way worse:

<Image src={driuzv} alt="" width="600" height="auto" />
...
<Image src={hqlitc} alt="" width="50" height="auto" />
...
<Image src={tbffpe} alt="" width="600" height="auto" />
...
<Image src={cmjcof} alt="" width="400" height="auto" />
...
<Image src={iottne} alt="" width="500" height="auto" />
...
<Image src={sslwen} alt="" width="700" height="auto" />
...
<Image src={nnkyev} alt="" width="700" height="auto" />
...
<Image src={rbnvuf} alt="" width="400" height="auto" />
...
<Image src={dmlame} alt="" width="500" height="auto" />
...
<Image src={oieexl} alt="" width="400" height="auto" />
