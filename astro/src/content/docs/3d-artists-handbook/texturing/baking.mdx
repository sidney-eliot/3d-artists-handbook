...
import ymhhcx from '../../../../assets/3d-artists-handbook/images/pasted-image-20230604230247.png'

:::note[Info]


**Make sure to have read the [Baking and Texturing Preparations](/3d-artists-handbook/texturing/baking-and-texturing-prep) before baking for the best result.**
...
* Bad preparation. [Baking and Texturing Preparations](/3d-artists-handbook/texturing/baking-and-texturing-prep)
...
<Image src={ymhhcx} alt="" width="500" height="auto" />
*(The image was brightend for better visualization)*
...
These passes are only needed if one wants to do texturing in Marmoset or is working with a textured [High Poly](/3d-artists-handbook/theory/glossary#low-high-poly) model that should be baked down to a [Low Poly](/3d-artists-handbook/theory/glossary#low-high-poly) model.
...
*ToDo: Go over use of baking in the film industry*
