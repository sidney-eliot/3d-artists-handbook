...
* [Fixing mesh topology](#mesh--topology)
* [Normals & shading](#normals--shading)
* [UV unwrapping](#uv-unwrapping)
* [Naming objects and file](#naming-conventions)
* [Color id mapping setup (if desired)](#color-id-mapping)
* [Proper export](#exporting)
...
Make sure to follow the concepts mentioned on the [Topology and Retopology](/3d-artists-handbook/theory/topology-and-retopology) page.
...
![image-2024-01-12-17-18-50.gif](../../../../assets/3d-artists-handbook/images/image-2024-01-12-17-18-50.gif)
*video by [Marmoset Toolbag](https://marmoset.co/posts/toolbag-baking-tutorial)*

This will result in normals pointing in the wrong direction like this:

![image-2024-01-12-17-29-22.jpg](../../../../assets/3d-artists-handbook/images/image-2024-01-12-17-29-22.jpg)
(1 bad normals, 2 good normals) *image by [EarthQuake](https://polycount.com/discussion/147227/skew-you-buddy-making-sense-of-skewed-normal-map-details)*
...
More on skewed normals in this Polycount [article](https://polycount.com/discussion/147227/skew-you-buddy-making-sense-of-skewed-normal-map-details). *(I don't fully agree with the statement, that adding edge loops to control shading is the best solution for the low mesh in the game industry.)*
...
:::tip[Smoothing / Shading (articles, videos)]
...
Lows:
Armor\_p014\_low (mostly the low will only have one piece)
Armor\_p015\_low

Highs:
Armor\_p014\_high\_001
Armor\_p014\_high\_002
Armor\_p014\_high\_003
Armor\_pt015\_high
...
When baking the color ID maps, make sure the colors are flat, so no [anti-aliasing](/3d-artists-handbook/theory/glossary#anti-aliasing). If the baker doesn't support that, Substance Painter has a tolerance slider for the ID map, which is fine as a last resort. The colors should also be as unique as possible from each other.

:::note[Baking color ID maps]
...
*(I've only done this in Marmoset Toolbag, but it should work quite similarly in other baking software like Substance Painter)*
...
:::tip[File format comparisons (articles)]


* [https://arsenal.cgtrader.com/blog/guide-to-3d-file-formats](https://arsenal.cgtrader.com/blog/guide-to-3d-file-formats)
