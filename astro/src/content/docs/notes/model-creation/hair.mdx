...
import uqttnu from '../../../../assets/notes/images/pasted-image-20230604170808.png'

import ilibsk from '../../../../assets/notes/images/pasted-image-20230604170824.png'

import jgsbcq from '../../../../assets/notes/images/pasted-image-20230604170858.png'

import pzwnyp from '../../../../assets/notes/images/pasted-image-20230604170907.png'

import clvpga from '../../../../assets/notes/images/pasted-image-20230604170758.png'

import eqzjhy from '../../../../assets/notes/images/pasted-image-20230604170921.png'

import ayuzuo from '../../../../assets/notes/images/pasted-image-20230604174906.png'

import vujjha from '../../../../assets/notes/images/pasted-image-20230604174914.png'

import qfeczz from '../../../../assets/notes/images/pasted-image-20230604174921.png'
...
<Image src={uqttnu} alt="" width="350" height="auto" /><Image src={ilibsk} alt="" width="350" height="auto" /><Image src={jgsbcq} alt="" width="300" height="auto" /><Image src={pzwnyp} alt="" width="300" height="auto" /><Image src={clvpga} alt="" width="250" height="auto" /><Image src={eqzjhy} alt="" width="600" height="auto" />
...
<Image src={ayuzuo} alt="" width="400" height="auto" /> <Image src={vujjha} alt="" width="400" height="auto" /> <Image src={qfeczz} alt="" width="400" height="auto" />
...
![Pasted image 20230604224005.png](../../../../assets/notes/images/pasted-image-20230604224005.png)
...
* Render with the correct image extension (more about that [here](/notes/theory/texture-maps))
...
* Place a flat colored neutral gray (#7F7F7F) background behind the hair (this is done to help the [anti aliasing](/notes/theory/glossary#anti-aliasing) by bouncing softer light and thus producing crisper edges)
