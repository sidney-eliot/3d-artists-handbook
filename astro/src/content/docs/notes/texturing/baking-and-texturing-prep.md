...
Make sure to follow the concepts mentioned on the [Topology and Retopology](/notes/theory/topology-and-retopology) page.
...
![image-2024-01-12-17-18-50.gif](../../../../assets/notes/images/image-2024-01-12-17-18-50.gif)
...
![image-2024-01-12-17-29-22.jpg](../../../../assets/notes/images/image-2024-01-12-17-29-22.jpg)
...
Look at the [UV Mapping](/notes/texturing/uv-mapping) page.
...
When baking the color ID maps, make sure the colors are flat, so no [anti-aliasing](/notes/theory/glossary#anti-aliasing). If the baker doesn't support that, Substance Painter has a tolerance slider for the ID map, which is fine as a last resort. The colors should also be as unique as possible from each other.
