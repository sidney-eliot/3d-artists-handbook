...
import wtldsa from '../../../../assets/notes/images/pasted-image-20230604230247.png'

:::note[Info]


**Make sure to have read the [Baking and Texturing Preparations](/notes/texturing/baking-and-texturing-prep) before baking for the best result.**
...
* Bad preparation. [Baking and Texturing Preparations](/notes/texturing/baking-and-texturing-prep)
...
<Image src={wtldsa} alt="" width="500" height="auto" />
...
These passes are only needed if one wants to do texturing in Marmoset or is working with a textured [High Poly](/notes/theory/glossary#low-high-poly) model that should be baked down to a [Low Poly](/notes/theory/glossary#low-high-poly) model.
