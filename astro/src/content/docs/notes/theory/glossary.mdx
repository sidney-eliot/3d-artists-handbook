...
import fdggpw from '../../../../assets/notes/images/20230603110116.png'

import wksoss from '../../../../assets/notes/images/20230603123401.png'

import hhtmtd from '../../../../assets/notes/images/20230603111140.png'

import dndhvn from '../../../../assets/notes/images/20230603111548.png'

import hafzbj from '../../../../assets/notes/images/20230603111310.png'

import itgarw from '../../../../assets/notes/images/20230603111506.png'

import gypmxb from '../../../../assets/notes/images/pasted-image-20230603124930.png'

import ghubsc from '../../../../assets/notes/images/pasted-image-20230603125616.png'

import lcbowc from '../../../../assets/notes/images/pasted-image-20230603125653.png'

import ihnrlo from '../../../../assets/notes/images/pasted-image-20230603130631.png'

import sblcnw from '../../../../assets/notes/images/pasted-image-20230603130821.png'

import msfdto from '../../../../assets/notes/images/pasted-image-20230603131037.png'
...
<Image src={fdggpw} alt="" width="600" height="auto" /> <Image src={wksoss} alt="" width="600" height="auto" />

On the flipped side, here's an example of ray tracing making the lighting and shadows look way worse:

<Image src={hhtmtd} alt="" width="600" height="auto" />
...
<Image src={dndhvn} alt="" width="50" height="auto" />
...
<Image src={hafzbj} alt="" width="600" height="auto" />
...
<Image src={itgarw} alt="" width="400" height="auto" />
...
<Image src={gypmxb} alt="" width="500" height="auto" />
...
<Image src={ghubsc} alt="" width="700" height="auto" />
...
<Image src={lcbowc} alt="" width="700" height="auto" />
...
<Image src={ihnrlo} alt="" width="400" height="auto" />
...
<Image src={sblcnw} alt="" width="500" height="auto" />
...
<Image src={msfdto} alt="" width="400" height="auto" />
