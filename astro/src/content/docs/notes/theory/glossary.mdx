...
import aqkhah from '../../../../assets/notes/images/20230603110116.png'

import rmlvkw from '../../../../assets/notes/images/20230603123401.png'

import rxgmxc from '../../../../assets/notes/images/20230603111140.png'

import jcpqyx from '../../../../assets/notes/images/20230603111548.png'

import lrbcum from '../../../../assets/notes/images/20230603111310.png'

import glvlyw from '../../../../assets/notes/images/20230603111506.png'

import bwqenk from '../../../../assets/notes/images/pasted-image-20230603124930.png'

import yynljo from '../../../../assets/notes/images/pasted-image-20230603125616.png'

import cexsma from '../../../../assets/notes/images/pasted-image-20230603125653.png'

import uquifv from '../../../../assets/notes/images/pasted-image-20230603130631.png'

import qsdqdo from '../../../../assets/notes/images/pasted-image-20230603130821.png'

import vvbxmb from '../../../../assets/notes/images/pasted-image-20230603131037.png'
...
* Adds depth
* Can be used as a budget [ray traced](/notes/theory/glossary#ray-tracing) occlusion
...
| :------------------------------------------------------------------: | :----------------------------------------------------------------: |
|    ![AO\_off\_1.png](../../../../assets/notes/images/ao_off_1.png)   |    ![AO\_on\_1.png](../../../../assets/notes/images/ao_on_1.png)   |
|    ![AO\_off\_2.png](../../../../assets/notes/images/ao_off_2.png)   |    ![AO\_on\_2.png](../../../../assets/notes/images/ao_on_2.png)   |
| ![tdmMtT4\_off.png](../../../../assets/notes/images/tdmmtt4_off.png) | ![tdmMtT4\_on.png](../../../../assets/notes/images/tdmmtt4_on.png) |
...
* Ray Traced Lighting
* Ray Traced [Ambient Occlusion](/notes/theory/glossary#ambient-occlusion)
...
<Image src={aqkhah} alt="" width="600" height="auto" /> <Image src={rmlvkw} alt="" width="600" height="auto" />

On the flipped side, here's an example of ray tracing making the lighting and shadows look way worse:

<Image src={rxgmxc} alt="" width="600" height="auto" />
...
<Image src={jcpqyx} alt="" width="50" height="auto" />
...
<Image src={lrbcum} alt="" width="600" height="auto" />
...
<Image src={glvlyw} alt="" width="400" height="auto" />
...
<Image src={bwqenk} alt="" width="500" height="auto" />
...
<Image src={yynljo} alt="" width="700" height="auto" />
...
<Image src={cexsma} alt="" width="700" height="auto" />
...
<Image src={uquifv} alt="" width="400" height="auto" />
...
<Image src={qsdqdo} alt="" width="500" height="auto" />
...
<Image src={vvbxmb} alt="" width="400" height="auto" />
...
Almost all render and game engines will convert **quads** and **n-gons** into **triangles** at render time. This is why it's important for **quads** and **n-gons** to be as planar as possible, as [triangulating](/notes/theory/glossary#triangulation) them can change the silhouette and shading when they aren't flat. More on that in the [triangulation](/notes/theory/glossary#triangulation) section.
...
**Triangulation**, also referred to as **tessellation**, is the process of the converting [quads and n-gons](/notes/theory/glossary#polygon-vertex-edge-triangle-quad-n-gon) to triangles. In the case of a quad, for example, there are two ways of **triangulating** it. The way in which quads and n-gons are triangulated depends on the algorithm that is used, and thus can differ between software and even versions of the same software.
