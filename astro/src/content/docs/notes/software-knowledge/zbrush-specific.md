...
![banner\_zbrush.jpg](../../../../assets/notes/images/banner_zbrush.jpg)

## General Things to Be Aware Of

* Having an efficient workflow between ZBrush and other software is key. More on that [here](/notes/model-creation/workflow-between-zbrush-and-blender)
