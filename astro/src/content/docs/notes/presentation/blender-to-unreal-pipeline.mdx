...
import trblao from '../../../../assets/notes/images/pasted-image-20230604230343.png'
...
<Image src={trblao} alt="" width="600" height="auto" />
...
7. Optionally correct the rest pose now as explained [blender-to-unreal-pipeline](/notes/presentation/blender-to-unreal-pipeline), if it isn't already correct
