...
2. In addition to that, it's also recommended to use a version control software, like [GitHub Desktop](https://desktop.github.com/download/).

2. Next, create your [own fork](https://github.com/sidney-eliot/3d-artists-handbook/fork) of this repository.

3. Then, inside a version control software like GitHub Desktop, add the repository you just forked via the clone function (_File > Clone repository_. The HTTPS link can be copied from the main repository page with the _<> Code_ button).

4. Inside the version control software, switch the branch to the one containing the development content (v4).

5. Inside the repository folder, using any terminal, execute the following commands:
...
And finally, when you are ready to share your changes via a [pull request](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/about-pull-requests),
...
|            **Bold**            | No standards yet. Maybe good for highlighting key terms, but try to use it sparingly.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |                                          |
...
> [!tip]
> Obsidian makes it easy to add new columns and rows to a table via a + button at the very bottom / right of tables (assuming you aren't currently in the source code view mode).
