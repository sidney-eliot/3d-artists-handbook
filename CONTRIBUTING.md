...
|      **Showing Hotkeys**       | Use [inline code](https://help.obsidian.md/Editing+and+formatting/Basic+formatting+syntax#Inline+code) _(or inline literals)_, separated with a `+`, to format each keystroke in a certain shortcut _(hotkey)_. (Inline code: `````)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |               `Ctrl` + `F`               |
